# [PL] Projekt "WIKI"
[English README.md](https://github.com/robi2212/project-wiki)
...
2. W pliku `main.py` w linijce `client.run('BOT_TOKEN_HERE')` wkleić token z utworzonej aplikacji bota w [Discord Developer Portal](https://discord.com/developers/home). [Skąd wziąć token do bota?](https://docs.discord.com/developers/quick-start/getting-started#fetching-your-credentials)
...
- [ ] Zapisywanie logów w określonym pliku na serwerze
- [ ] Wprowadzenie poleceń
    ...
    - [ ] /ping - rozbudowa polecenia o szybkość reakcji (w ms)
- [ ] Odpowiadanie na określone słowa
- [ ] Rozdzielenie kodu na osobne pliki
