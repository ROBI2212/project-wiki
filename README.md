...
- [] Zliczanie wiadomości użytkowników
- [] Integracja z systemem Uptime Kuma przez webhook
- [] Informuje o opublikowanych filmach na wskazanym kanale [YouTube](https://youtube.com)
- [] Liczy "streak" codziennych opublikowanych filmów
